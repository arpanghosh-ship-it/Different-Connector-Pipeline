...
POLL_INTERVAL_SECONDS = int(os.getenv('POLL_INTERVAL_SECONDS', '30'))  # kept for reference

# Webhook — must be a publicly reachable HTTPS URL pointing at this server.
# For local dev: run  `ngrok http 8000`  and set this to the https:// URL ngrok prints.
